...
class PlaceSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $sjis = file_get_contents('database/seeders/csv/zenkoku.csv');
        $utf8 = mb_convert_encoding($sjis, 'UTF-8', 'SJIS-win');
        file_put_contents('database/seeders/csv/zenkoku_utf-8.csv', $utf8);

        $fp = new \SplFileObject('database/seeders/csv/zenkoku_utf-8.csv', 'rb');
        $fp->setFlags(
